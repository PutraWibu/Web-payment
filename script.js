function startDanaPayment() {
    ...
    window.location.href = "https://jexploit-x.github.io/Web-payment/paydana.html"; // Change to actual payment URL
}
...
function startQRISPayment() {
    ...
    // You can replace this with actual payment logic
    window.location.href = "https://link-to-qris-payment"; // Change to actual QRIS payment URL
}